...
const ViewProForm = () => {
  ...
  return (
    <div className='viewformpro'>
      <section>
        <div className="viewformform">
          <form action="">
          <h2>Standard Form</h2>
            ...
            <div className="input-box third">
              ...
              <div className="input-box-elem three" >
                <h6>Ph Number</h6>
                <input type="text" value={form ? form.phNumber : ''}  readOnly/>
              </div>
      ...
      >
        ...
        <DialogActions>
          ...
          <Link to = {`/editproform/${form ? form._id : ''}`} >
