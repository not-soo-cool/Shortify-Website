...
import { UpdateForm, viewForm } from '../../../../../Actions/FormAction'; 
...
const EditForm = () => {
  ...
  const handleFormSubmit = async(e) => {
    e.preventDefault();
    setOpen(false);
    await dispatch(UpdateForm(params.id, fname, first, last, email, password, username, dob, gender, address, city, state, postal));
  }
